...
var MainManager = function () {
    ...
    p && ($("#bt_fs").css("display", "block"), $("#bt_fs").click(function (a) {
        ...
        switch (g) {
            case 1:
                ...
                break;
            default:
                location.href = "https://whatanerb.github.io"
        }
    }), $("#bt_backtrack a").click(i);
    u = aidn.util.checkJapanese();
    var m = aidn.util.checkMobile(), y = "Mikutap";
    ...
    var w, M, I, x, b, C = 0, g = 0, P = new function () {
        function a() {
            c && c()
        }
        ...
        var c, f, u = s[0].length, v = 0, p = 6e4 / 280
    }, T = new function () {
        function a() {
            d && d()
        }
        ...
        this.init = function (n, t) {
            ...
            var o = 1e3 * (aidn.___waContext.currentTime + l[a] - I), s = Math.floor(o / c);
        ...
        var d = function (a, e) {
            ...
            var n = 0, t = 0, i = 0, o = 0, r = new PIXI.Graphics;
            ...
            function n() {
                ...
                var e, n;
                if (0 == o) for (var t = 0; t < h.rotation; t += 30) e = (s * t + l) * Math.PI / 180, n = Math.cos(e) * a, e = Math.sin(e) * a, c.lineTo(n, e); else for (t = 360; h.rotation < t; t -= 30) e = (s * t + l) * Math.PI / 180, n = Math.cos(e) * a, e = Math.sin(e) * a, c.lineTo(n, e);
                e = (s * h.rotation + l) * Math.PI / 180, n = Math.cos(e) * a, e = Math.sin(e) * a, c.lineTo(n, e), c.lineTo(0, 0), c.endFill()
            }

            function t() {
                o = 1, TweenLite.fromTo(h, .9, {rotation: 0}, {
                    rotation: 360,
                    ease: Power1.easeOut,
                    onUpdate: n,
                    onComplete: i
            ...
            this.play = function (a, e) {
                o = 0, d = a, r = e, l = 360 * Math.random(), s = 1, .5 > Math.random() && (s = -1), c.clear(), c.beginFill(0), c.moveTo(0, 0), c.lineTo(1, 1), c.endFill(), TweenLite.fromTo(h, .6, {rotation: 0}, {
                    rotation: 360,
                    ease: Power1.easeOut,
                    onUpdate: n,
                    onComplete: t
            ...
            var o, r, l, s, d, h = {rotation: 0}, c = new PIXI.Graphics;
            a.addChild(c), e.mask = c
        }, c = function (a) {
            function e() {
                h.clear(), 0 == i ? h.lineStyle(r, o) : h.beginFill(o);
                for (var a = 0; a < s; a++) {
                    var e = c["p" + a].x, n = c["p" + a].y;
            ...
            this.play = function (a, f) {
                ...
                for (var p = 360 / s, m = 0; m < s; m++) {
                    var y = m * p * Math.PI / 180, I = u * Math.cos(y),
                        x = (y = u * Math.sin(y), I + u * (Math.random() - .5) * v),
                        b = y + u * (Math.random() - .5) * v;
                    c["p" + m] = {x: I, y: y}, TweenLite.to(c["p" + m], .6, {x: x, y: b})
                }
                c.progress = 0, TweenLite.to(c, .8, {progress: 1, onUpdate: e, onComplete: n})
            };
            var t, i, o, r, s, d = a, h = new PIXI.Graphics;
            d.addChild(h);
            var c = {}
        }, f = function (a, e) {
            function n() {
            ...
            var t = function (a) {
                ...
                function n() {
                    0 == c ? (c = 1, r = {x: i.x, y: i.y}, TweenLite.to(r, h, {
                        x: o.x,
                        y: o.y,
                        ease: Power1.easeOut,
                        onUpdate: e,
                ...
                this.play = function (a, f, u, v) {
                    return t.visible = !0, c = 0, i = a, o = f, l = u, s = v, d = .2 * Math.random() + .2, h = .2 * Math.random() + .2, r = {
                        x: i.x,
                        y: i.y
                    }, TweenLite.to(r, d, {x: o.x, y: o.y, ease: Power1.easeOut, onUpdate: e, onComplete: n}), d + h
                };
            ...
            this.play = function (a) {
                ...
                for (var h, c = e / a * (.4 * Math.random() + .7), f = e / a * (.4 * Math.random() + .1), u = l(), v = 0, p = 0; p <= a; p++) {
                    var m = {x: -e / 2, y: h = (p - .5 * a) * c}, y = {x: e / 2, y: h};
        ...
        this.resize = function () {
            ...
            C = !0, X = new PIXI.Container, b.addChild(X), u = new PIXI.Container, b.addChild(u), (z = new function (a) {
                ...
                var t = this, i = 16777215, o = new PIXI.Graphics, r = a;
                r.addChild(o)
        ...
        var u, v = -1, y = 4, I = 8, x = !1, C = !1, g = [], P = [function (a, e) {
            function n() {
            ...
            var t = function (a) {
                ...
                this.play = function (a, t, i) {
                    n.visible = !0, n.clear();
                    var o = w * Math.random(), r = M * Math.random(), l = Math.min(w, M) * (.03 * Math.random() + .02);
                    return n.lineStyle(3 * Math.random() + 3, i), n.drawCircle(0, 0, l), n.x = a, n.y = t, n.scale.x = 0, n.scale.y = 0, n.rotation = Math.random() * Math.PI, a = .2 * Math.random() + .4, TweenLite.to(n, a, {
                        ...
                        ease: Power3.easeOut,
                        onComplete: e
                    }), TweenLite.to(n.scale, a, {x: 1, y: 1, ease: Back.easeOut.config(1.7)}), a
                };
            ...
            var t = function (a) {
                ...
                this.play = function (a, t, i) {
                    n.visible = !0, n.clear();
                    var o = w * Math.random(), r = M * Math.random(), l = Math.min(w, M) * (.04 * Math.random() + .02);
            ...
            var t = function (a) {
                ...
                function n() {
                    TweenLite.to(l.scale, .4, {x: 0, y: 0, ease: Power2.easeOut, onComplete: t, delay: .1})
                }
            ...
            this.play = function () {
                ...
                for (var a = 10, e = l(), i = Math.min(w, M) / 64 * (.6 * Math.random() + .7), d = 2, h = 0; 40 > h; h++) {
                    var c, f = 25 * h * Math.PI / 180, u = a * Math.cos(f);
            ...
            this.play = function () {
                ...
                var a = l(), e = Math.min(w, M) * (.28 * Math.random() + .2), t = Math.floor(5 * Math.random()) + 3;
                r.clear(), r.lineStyle(7 * Math.random() + 4, a, 1), r.rotation = 30 * Math.floor(6 * Math.random());
                a = 360 / t;
                for (var d = 0; d <= t; d++) {
                    var h = d * a * Math.PI / 180, c = e * Math.cos(h);
                    h = e * Math.sin(h);
                ...
                t = .8 * Math.random() + .4, a = .8 * Math.random() + .4, TweenLite.fromTo(r.scale, .9, {
                    x: t,
                    y: t
                }, {x: a, y: a, ease: Bounce.easeOut}), s.play(e, n)
            };
            var t = this, i = a;
            this.id = e;
            var o = new PIXI.Container, r = new PIXI.Graphics;
            ...
            var t = function (a) {
                function e() {
                    var a = Math.min(w, M), e = a * (.08 * Math.random() + .05);
                    r.lineStyle(4 * Math.random() + 4, l()), r.drawRect(-e / 2, -e / 2, e, e), r.x = i + a / 2 * (Math.random() - .5), r.y = o + a / 2 * (Math.random() - .5), r.scale.x = 0, r.scale.y = 0, r.rotation = Math.random() * Math.PI, TweenLite.to(r, .5, {
                        ...
                        onComplete: n
                    }), TweenLite.to(r.scale, .5, {x: 1, y: 1, ease: Back.easeOut.config(1.7)})
                }

                function n() {
                    var a = Math.min(w, M), e = i + a / 2 * (Math.random() - .5);
                    ...
                    TweenLite.to(r, .5, {
                        ...
                        onComplete: t,
                        delay: .2
                    }), TweenLite.to(r.scale, .5, {x: 0, y: 0, ease: Back.easeIn.config(1.7), delay: .2})
                }
            ...
            var t = function (a) {
                ...
                function n() {
                    TweenLite.to(r.scale, .5, {x: 0, y: 0, ease: Back.easeIn.config(1.7), onComplete: t, delay: .2})
                }
            ...
            this.play = function () {
                ...
                var e = (a = 45 * Math.PI / 180 * Math.floor(2 * Math.random())) + 45 * Math.PI / 180 * Math.floor(4 * Math.random() - 2),
                    t = .3 * Math.random() + 1, s = .3 * -Math.random() + 1;
                TweenLite.fromTo(l.container, .6, {rotation: a}, {
                    rotation: e,
                    ease: Power2.easeOut
                }), TweenLite.fromTo(l.container.scale, .6, {x: t, y: t}, {
                    x: s,
                    y: s,
                    ease: Back.easeOut.config(1.7)
                }), TweenLite.fromTo(r.scale, .6, {x: t, y: t}, {x: s, y: s, ease: Back.easeOut.config(1.7)})
            };
            var t = this, i = a;
            this.id = e;
            ...
            this.play = function () {
                ...
                for (var a = .6 * Math.min(w, M), e = Math.floor(5 * Math.random()) + 3, t = 360 / e, r = .5 * Math.max(w, M) / a * (1.6 + .6 / e), s = 0; s <= e; s++) {
                    var d = s * t * Math.PI / 180, h = a * Math.cos(d);
                    d = a * Math.sin(d);
                    0 == s ? o.moveTo(h, d) : o.lineTo(h, d)
                }
                a = .3 * Math.random() + .6, TweenLite.fromTo(o.scale, a, {x: 0, y: 0}, {
                    x: r,
                    y: r,
                    onComplete: n,
                    ease: Power2.easeOut
                }), TweenLite.fromTo(o, a, {rotation: Math.random() * Math.PI}, {
                    rotation: Math.random() * Math.PI,
                    ease: Power1.easeOut
                })
            };
            ...
            this.play = function () {
                i.setChildIndex(o, i.children.length - 1), o.visible = !0, o.x = w / 2, o.y = M / 2;
                var a = l(), e = Math.min(w, M) * (.25 * Math.random() + .1);
            ...
            var t = function (a) {
                ...
                this.init = function (a, e, n, t) {
                    ...
                    t = n, i.clear(), i.visibloe = !0, i.beginFill(l), i.drawRect(.5 * -o, .5 * -o, o, o), TweenLite.fromTo(i.scale, .3, {
                        ...
                        onComplete: e,
                        delay: a
                    }), TweenLite.fromTo(i, .7, {rotation: Math.random() * Math.PI * 2}, {
                        rotation: 0,
                        ease: Elastic.easeOut.config(1, .3),
                        delay: a
                    });
            ...
            this.play = function () {
                ...
                var a = Math.floor(8 * Math.random() + 6), e = Math.min(w, M) * (.25 * Math.random() + .25),
                    i = 360 / a, d = e * (.15 * Math.random() + .05), h = l(),
                    c = Math.PI / 2 * Math.floor(4 * Math.random()), f = 1;
                .5 > Math.random() && (f = -1);
                for (var u = 0; u < a; u++) {
                    var v, p = (f * i * u + c) * Math.PI / 180, m = e * Math.cos(p);
                    p = e * Math.sin(p);
                    v = s[u] ? s[u] : new t(r);
                    var y = null;
            ...
            var t = function (a) {
                function e() {
                    var a = .5 * w, e = i.x + Math.random() * a - a / 2;
                    ...
                    TweenLite.to(i.scale, .3, {
                        ...
                        onComplete: n,
                        delay: .5
                    }), TweenLite.to(i, .3, {x: e, y: a, ease: Power2.easeOut, delay: .5})
                }
                ...
                this.init = function (a, e, n, t) {
                    ...
                    t = n, i.clear(), i.visibloe = !0, i.beginFill(r), i.drawCircle(0, 0, .5 * o), TweenLite.fromTo(i.scale, .3, {
                        x: 0,
                        y: 0
                    }, {x: 1, y: 1, ease: Back.easeOut.config(1.7), onComplete: e, delay: a})
                };
                var t, i = new PIXI.Graphics;
                a.addChild(i);
                var o, r
            ...
            this.play = function () {
                o.setChildIndex(r, o.children.length - 1), r.visible = !0, r.x = w / 2, r.y = M / 2;
                var a = Math.floor(8 * Math.random() + 6), e = Math.min(w, M) * (.2 * Math.random() + .25), i = 360 / a,
                    d = e * (.2 * Math.random() + .05), h = l(), c = Math.PI / 2 * Math.floor(4 * Math.random()), f = 1;
                .5 > Math.random() && (f = -1);
                for (var u = 0; u < a; u++) {
                    var v, p = (f * i * u + c) * Math.PI / 180, m = e * Math.cos(p);
                    p = e * Math.sin(p);
            ...
            this.play = function () {
                ...
                var a = Math.min(w, M) * (.7 + .2 * Math.random()), e = a / 10 * (.5 + .8 * Math.random()), t = l();
                r.clear(), r.beginFill(t), r.drawRect(0, -e / 2, a, e), s.clear(), s.beginFill(t), s.drawRect(-e / 2, 0, e, a), r.y = 0, r.x = -a / 2, s.x = 0, s.y = -a / 2, o.rotation = 45 * Math.PI / 180, r.scale.x = 0, s.scale.y = 0, a = .5 > Math.random() ? -135 * Math.PI / 180 : 215 * Math.PI / 180, (new TimelineLite).to(r.scale, .4, {
                    x: 1,
                    ease: Power2.easeOut
                }).to(s.scale, .4, {y: 1, ease: Power2.easeOut}, .1).to(o, .6, {
                    rotation: a,
                    ease: Back.easeOut.config(1.7)
                }, 0).to(r.scale, .3, {x: 0, ease: Power2.easeOut}).to(s.scale, .3, {
                    y: 0,
                    ease: Power2.easeOut,
                    onComplete: n
                }, .6)
            ...
            var t = this, i = a;
            this.id = e;
            var o = new PIXI.Container, r = new PIXI.Graphics, s = new PIXI.Graphics;
            ...
            function n() {
                if (h++, i < h) switch (o) {
                    ...
                    case 1:
                        o = 2
                } else TweenLite.to(c, .1, {x: d[h].x, y: d[h].y, onComplete: n, onUpdate: t, ease: Power1.easeOut})
            }
            ...
            var i, o, r, s, d = [], h = 0, c = {x: 0, y: 0}, f = new PIXI.Graphics;
            a.addChild(f)
        }, f], k = [function (a, e) {
            function n() {
            ...
            this.play = function () {
                ...
                i.pos = {};
                var f = 0;
                a ? (f = M / e, i.pos.b0 = {x: 0, y: 0}, i.pos.b1 = {x: 0, y: M}) : (f = w / e, i.pos.b0 = {
                    x: 0,
                    y: 0
                }, i.pos.b1 = {
                    x: w,
                ...
                for (var u = l = 0; u <= e; u++) {
                    var v = {x: 0, y: 0}, p = 0;
                    0 != u && u != e && (p = f / 4 * Math.random() - f / 8), a ? v.y = f * u + p : v.x = f * u + p, i.pos["p" + u] = v, v = .4 * Math.random() + .3, l = 2, TweenLite.to(i.pos["p" + u], v, a ? {x: w} : {y: M})
                }
                i.progress = 0, TweenLite.to(i, l, {progress: 1, ease: Power0.easeNone, onUpdate: n, onComplete: t})
            };
            var i = this, o = a;
            this.id = e, this.progress = 0, this.pos = {};
            var r, l, d = 0, h = new PIXI.Graphics;
            o.addChild(h);
        ...
        var z,
            ...
            S = E.length, A = 0, D = 0
    }, _ = !1, L = 0, O = "off", X = "off" == aidn.util.getCookie("bt");
    ...
    function a() {
        if (l++, r.now = l, i && i(l, e), e <= l) t && t(); else {
